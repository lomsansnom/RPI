...
/*	var clientData = "",
	...
	webserviceReq.write ( data );
	webserviceReq.end ( );*/
	var file = fs.createWriteStream("mus.mp3");
	var req = http.get("http://192.168.1.87:9090/getMusique/%2Fhome%2Falex%2FsaveWindows%2FMusique%2Fzaz-zaz%2F01-Les%20passants.mp3", function(res) {
	    res.pipe(file);
	});
}

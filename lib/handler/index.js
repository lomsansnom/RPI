...
{
	exec('sudo cat /etc/mtab | grep ' + req.body['repertoire'], function(error, stdout, stderr){
		if(error !== null)
		{
			console.log("erreur lors de l'exécution de cat /etc/mtab | grep " + req.body['repertoire'] + " : " + error)
		}
		else
		{
			console.log("stderr de cat /etc/mtab | grep " + req.body['repertoire'] + " : " + stderr)
			console.log("stdout de cat /etc/mtab | grep " + req.body['repertoire'] + " : " + stdout)
		}
	})
};

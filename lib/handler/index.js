...
function requeteFichierWS(url, nomMusique, conf) {
	var file = fs.createWriteStream(nomMusique);
	var urlWS = conf.webservicePlayer.address + ":" + conf.webservicePlayer.port + url
